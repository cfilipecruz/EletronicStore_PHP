<?php
$json = file_get_contents("https://newsapi.org/v2/everything?q=technology&{datetime;yyyy-MM-dd}&sortBy=publishedAt&apiKey=c00977ab88eb4cf2b7c9a178f53e144b");
...
<div class="secondary-menu">
    <ul class="secondary-menu-li">
        ...
        <a class="btatualizar" href=" <?php $_SERVER['PHP_SELF']; ?>" > Update </a>
    </ul>
</div>



<div style="margin-top: 20px; display: block;" class="container">
    <?php foreach($array['articles'] as $article){
        echo '<div class="row tec">

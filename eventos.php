...
$sqlQuery = "SELECT * FROM evento ORDER BY id DESC";
...
if($_SESSION['admin']==1){
    echo'     
                    <div class="addevents"> 
                        <form method="POST" action="eventospost.php">
                              <label for="fname">Name:</label>
                              <input type="text" id="fname" name="nome">
                              <label for="lname">Date:</label>
                              <input type="text" id="lname" name="data">
                              <label for="lname">Description:</label>
                              <input type="text" id="lname" name="descricaop">
                    ...
                    echo "         
                            <div class='events'>
                                          <div class='eventstext'>
                                                 <h3><b>Tipo: " . $row['nome'] . "</b></h3>
                                                 <h5>Data: " . $row['data'] . "</h5>
                                                 <p>Descrição: " . $row['descricaop'] . "</p>
                                          </div>
                                          <a href='#'>Participate</a>
                                          <a href='eventosdelete.php?id=".$row['id']."'>Delete</a>
                            </div>
                            ";
                }else {
                    echo "         

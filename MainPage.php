<?php
$json = file_get_contents("https://v2.jokeapi.dev/joke/Programming");
...
<html lang="en">
    ...
    <script>
        window.onload = function () {
            startTimerSales();
            displayNextImageSales();
            startTimerNews();
            displayNextImageNews();
            displayNextImageTop();
            startTimerTop();
        };
    </script>
    ...
    <body>
        ...
        <div class="windows">
                ...
                <div style="margin-left: 0px;" class="windows-inside">
                    <h5 style="margin-top: 30px;"> Sales </h5>
                    <div style="margin-left: 0px; display: flex;">
                        <a onclick="displayPreviousImageSales()" style="cursor: pointer; float:left; font-size: 20px;">Previous</a>
                        <img class="img" id="imgsales" src="startpicture.jpg"/>
                        <a onclick="displayNextImageSales()" style=" cursor: pointer; float:left; font-size: 20px;">Next</a>
                    </div>

                </div>
                <div class="windows-inside">
                    <h5 style="margin-top: 30px;"> News </h5>
                    <div style="margin-left: 0px; display: flex;">
                        <a onclick="displayPreviousImageNews()" style="cursor: pointer; float:left; font-size: 20px;">Previous</a>
                       <img class="img" id="imgnews" src="startpicture.jpg"/>
                        <a onclick="displayNextImageNews()" style=" cursor: pointer; float:left; font-size: 20px;">Next</a>
                    </div>
                </div>
                <div style="margin-right: 0px;" class="windows-inside">
                    <h5 style="margin-top: 30px;"> Top Sells </h5>
                    <div style="margin-left: 0px; display: flex;">
                        <a onclick="displayPreviousImageTop()" style="cursor: pointer; float:left; font-size: 20px;">Previous</a>
                        <img class="img" id="imgtop" src="startpicture.jpg"/>
                        <a onclick="displayNextImageTop()" style=" cursor: pointer; float:left; font-size: 20px;">Next</a>
                    </div>
                </div>
        </div>
        ...
        <!--events------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
        <div class="events">
            <h1 style="text-align: center; display: flex; margin: auto; margin-left: 0px; "> Check our Events: </h1>
            <a href="eventos.php"> Click Here </a>
        </div>
            ...
            <div class="joke">
                ...
                <h4><?php
                    ...
                    echo' "'.$array['delivery'].'"';
                    ?></h4>
                <a href=" <?php $_SERVER['PHP_SELF']; ?>" > New </a>
            </div>
